...
func anchor(top: NSLayoutYAxisAnchor?, left: NSLayoutXAxisAnchor?, bottom: NSLayoutYAxisAnchor?, right: NSLayoutXAxisAnchor?,  paddingTop: CGFloat, paddingLeft: CGFloat, paddingBottom: CGFloat, paddingRight: CGFloat, width: CGFloat, height: CGFloat) {
    ...
    extension UIColor {
        ...
        static func mainPurple() -> UIColor {
            return UIColor.rgb(red: 165, green: 18, blue: 228)
        }
        ...
        static func lightBlack() -> UIColor {
            return UIColor.rgb(red: 40, green: 40, blue: 40)
        }
        
        static func GoldenBrown () -> UIColor {
            return UIColor.rgb(red: 153, green: 101, blue: 21)
        }
        
        static func DarkerGoldenBrown () -> UIColor {
            return UIColor.rgb(red: 129, green: 83, blue: 14)
        }
        
        static func AppBlue () -> UIColor {
            return UIColor.rgb(red: 25, green: 65, blue: 105)
        }
        
        static func AppDarkBlue () -> UIColor {
            return UIColor.rgb(red: 0, green: 65, blue: 105)
        }
        static func CouponColor () -> UIColor {
            return UIColor.rgb(red: 199, green: 178, blue: 153)
        }
